...
public class DataReader {
	...
	// TODO: Add the squared features to the dataset
	public static DataSet createDataSetFromCSVSquared(String filepath, int linesToSkip, String[] fileColumnHeaders) {
		String data = normalizeLineBreaks(readFileAsString(filepath));
		String[] lines = data.split("\n");
